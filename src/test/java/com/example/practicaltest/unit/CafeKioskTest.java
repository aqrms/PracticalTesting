...
class CafeKioskTest {
    ...
    void createOrderWithOpenTime() {
        ...
        Order order = cafeKiosk.createOrder(LocalDateTime.of(2024, 4, 1, 10, 0));
    ...
    @Test
    void createOrderWithCloseTime() {
        CafeKiosk cafeKiosk = new CafeKiosk();
        Americano americano = new Americano();
        cafeKiosk.add(americano);

        assertThatThrownBy(() -> cafeKiosk.createOrder(LocalDateTime.of(2024, 4, 1, 9, 59)))
            .isInstanceOf(IllegalArgumentException.class)
